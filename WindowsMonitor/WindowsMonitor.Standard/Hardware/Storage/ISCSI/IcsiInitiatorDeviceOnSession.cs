...
namespace WindowsMonitor.Hardware.Storage.ISCSI
{
    /// <summary>
    /// </summary>
    public sealed class IcsiInitiatorDeviceOnSession
    {
        ...
        public static IEnumerable<IcsiInitiatorDeviceOnSession> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<IcsiInitiatorDeviceOnSession> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\wmi"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<IcsiInitiatorDeviceOnSession> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new IcsiInitiatorDeviceOnSession
                {

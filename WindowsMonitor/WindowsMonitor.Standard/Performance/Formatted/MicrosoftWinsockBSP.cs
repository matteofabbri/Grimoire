...
namespace WindowsMonitor.Performance.Formatted
{
    /// <summary>
    /// </summary>
    public sealed class MicrosoftWinsockBsp
    {
        ...
        public static IEnumerable<MicrosoftWinsockBsp> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<MicrosoftWinsockBsp> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<MicrosoftWinsockBsp> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new MicrosoftWinsockBsp
                {

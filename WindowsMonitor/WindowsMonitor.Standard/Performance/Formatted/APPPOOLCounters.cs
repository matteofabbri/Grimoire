...
namespace WindowsMonitor.Performance.Formatted
{
    /// <summary>
    /// </summary>
    public sealed class AppPoolCounters
    {
        ...
        public static IEnumerable<AppPoolCounters> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<AppPoolCounters> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<AppPoolCounters> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new AppPoolCounters
                {

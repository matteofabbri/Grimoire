...
namespace WindowsMonitor.Performance.Formatted
{
    /// <summary>
    /// </summary>
    public sealed class AppPoolCountersProvider
    {
        ...
        public static IEnumerable<AppPoolCountersProvider> Retrieve(string remote, string username, string password)
        {
        ...
        public static IEnumerable<AppPoolCountersProvider> Retrieve()
        {
            var managementScope = new ManagementScope(new ManagementPath("root\\cimv2"));
            return Retrieve(managementScope);
        }

        public static IEnumerable<AppPoolCountersProvider> Retrieve(ManagementScope managementScope)
        {
            ...
            foreach (ManagementObject managementObject in objectCollection)
                yield return new AppPoolCountersProvider
                {
